                                ...
                                <div class="row"  v-for="(el,indx) in JSON.parse(item.prod_attr)">
                                    ...
                                    <div class="col col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col text-right">{{el.prd_size_s}}</div>
                                            <div class="col text-right">{{el.prd_s_regular_price}}</div>
                                            <div class="col text-right">{{el.prd_s_price}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col">Medium</div>
                                            <div class="col text-right">{{el.prd_size_m}}</div>
                                            <div class="col text-right">{{el.prd_m_regular_price}}</div>
                                            <div class="col text-right">{{el.prd_m_price}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col">Large</div>
                                            <div class="col text-right">{{el.prd_size_l}}</div>
                                            <div class="col text-right">{{el.prd_l_regular_price}}</div>
                                            <div class="col text-right">{{el.prd_l_price}}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col">XLarge</div>
                                            <div class="col text-right">{{el.prd_size_xl}}</div>
                                            <div class="col text-right">{{el.prd_xl_regular_price}}</div>
